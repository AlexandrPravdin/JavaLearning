...
public class TextApp extends JFrame {
    ...
    JComboBox comboBoxFont;

    public TextApp() {
        textArea = new JTextArea();
        font = new Font("Times new Roman", Font.BOLD, 20);
        comboBoxColor = new JComboBox(new String[]{"Black", "Blue", "Red"});
        comboBoxFont = new JComboBox(new String[]{"Times New Roman", "MS Sans Serif", "Courier New"});
        setSize(400, 400);
